...
- **Future Improvement (Refactoring)**:
  - I plan to revisit this code later to optimize the performance.
  - Goal: I will refactor the current logic to improve efficiency and refine the algorithm into a more sophisticated structure.
